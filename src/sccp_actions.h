...
void sccp_handle_ConnectionStatistics(constSessionPtr s, devicePtr d, constMessagePtr msg_in);
...
void sccp_handle_XMLAlarmMessage(constSessionPtr s, devicePtr d, constMessagePtr msg_in);

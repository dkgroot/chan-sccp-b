...
void sccp_utils_reduceCodecSet(skinny_codec_t baseCodecs[SKINNY_MAX_CAPABILITIES], const skinny_codec_t reduceByCodecs[SKINNY_MAX_CAPABILITIES]);
void sccp_utils_combineCodecSets(skinny_codec_t baseCodecs[SKINNY_MAX_CAPABILITIES], const skinny_codec_t addCodecs[SKINNY_MAX_CAPABILITIES]);
